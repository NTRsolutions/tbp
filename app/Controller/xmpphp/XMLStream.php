...
class XMPPHP_XMLStream {
	...
	public function send($msg, $timeout=NULL) {
		...
		//$this->log->log("SENT: " . substr($sentbytes, 0, 8), XMPPHP_Log::LEVEL_VERBOSE);
		
		//echo mb_substr($msg, 0, $sentbytes, '8bit')."--------------".substr($sentbytes, 0, 8);
		
		//$this->log->log("SENT: " . substr($msg, 0, $sentbytes, '8bit'), XMPPHP_Log::LEVEL_VERBOSE);
		//"<br>";
		//echo "ashish S--1----".substr($msg, 0, 8);
		//"<br>";
		//echo "ashish_1--".mb_substr($msg, 0, $sentbytes, '8bit')."-ashish_2--".substr($sentbytes, 0, 8)."-ashish_3-- ".substr($msg, 0, 8);
		//echo "<br>";
		
		//echo $msg."--hi--".$sentbytes."<br>";
