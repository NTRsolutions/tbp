...
<div class="campaigns index" >
	<div class="panel panel-info">
		<?php	echo $this->Html->link(__('Export'), array('action' => 'exportCampaigns',$CmpStatus),array('id'=>'exp_btn','class'=>'btn btn-raised pull-right','title'=>'Export to Excel'));?>
		<div class="panel-heading">
			<h1 class="panel-title">
					...
					<?php }
					?>
				<!-- <button class="btn btn-xs btn-warning">asd</button> -->
			</h1>
			...
			<div class="row">
				...
				<?php echo $this->Form->hidden('campStatus',array(
		            ...
		            <div class="col-xs-3">
						<div class="input-group">
							<span class="input-group-addon"><span class="glyphicon glyphicon-search"></span></span>
							<?php echo $this->Form->input("client_id",array('empty' => 'Client Name','label'=>false,'selected'=>$ClientID,'class'=>'form-control')); ?>
		                </div>
		            </div>
		            <div class="col-xs-3">
		            ...
		            <div class="col-xs-3">
		                <input type="submit" id="searchCampaigns" onclick="return validate();" class="btn btn-info pull-right" value="Search">
		            </div>
